...
for chat in st.session_state["conversation_history"]:
    if chat["role"] == "client":
        st.markdown(
            ...
            <div style='text-align: right; margin-bottom: 20px;'>
                <div style='font-size: 16px; color: #808080 ;'>👨‍⚕️ 来访者</div>
                <div style='display: inline-block; text-align: left; background-color:#E0FFFF; padding: 10px; border-radius: 10px; font-size: 20px; margin-top: 5px; color: black;'>{chat['content']}</div>
            </div>
            """, 
            unsafe_allow_html=True
        )
        ...
        st.markdown(
            ...
            <div style='text-align: left; margin-bottom: 20px;'>
                <div style='font-size: 16px; color:#808080 ;'>🧑 咨询师</div>
                <div style='display: inline-block; text-align: left; background-color: #FFFFFF; padding: 10px; border-radius: 10px; font-size: 20px; margin-top: 5px; color: black;'>{chat['content']}</div>
            </div>
            """, 
            unsafe_allow_html=True
        )
